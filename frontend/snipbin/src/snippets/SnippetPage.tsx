...
export default function SnippetPage() {
  ...
  return (<>
    <div className="px-pc mb-24">
      ...
      <div id="code-short" className="relative bg-gray-custom flex px-3 mt-3.5 mb-7 justify-between items-start rounded-xl">
      ...
      <div id="code-example" className="relative bg-gray-custom flex px-3 justify-between items-start rounded-xl">
